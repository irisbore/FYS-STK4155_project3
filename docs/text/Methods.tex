...
\iris{Should we mention kernel and filter here, or move it further up in the cnn section?} 
\subsubsection{Padding and Pooling:}
\iris{I moved this nice section from the implementation, but kept the range values.}
