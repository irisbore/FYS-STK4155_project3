...
Our grid search with pooling and convolutional layer 
...
\begin{table}[H]
    \centering
    \caption{The runtimes of a a grid search experimenting with adding padding and pooling after the convolutional layers \iris{is this correct?}}
\begin{tabular}{|l|l|l|}
\hline
